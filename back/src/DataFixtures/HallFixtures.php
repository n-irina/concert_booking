    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $halls = [
            ...
            [
                ...
                "picture_path" => "gaite_lyrique.jpg"
            ],
            [
        ...
        foreach($halls as $one_hall){
            ...
            $hall->setPicturePath($one_hall["picture_path"]);
